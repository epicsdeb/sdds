...
-fileValues=<filename>[,energy=<columnName or wavelength=columnName>] \n\
                   get the energy or waveformlengt of filename instead of by -mode option. \n\
...
sddssyncflux calculates the photo flux of synchrotron radiation. \n\
Program by Hairong Shang, ANL (This is version 1.0, "__DATE__".)";

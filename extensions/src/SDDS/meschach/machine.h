...
/* RCS id: $Id: machine.h,v 1.10 2009/12/01 21:43:27 soliday Exp $ */
...
#if defined(vxWorks) || defined(__BORLANDC__) || defined(linux) || defined(_AIX) || defined(__rtems__) || defined(__CYGWIN__)
#ifndef HUGE_VAL

...
epicsShareFunc gdImagePtr gdImageCreateFromPng (FILE * fd);
...
epicsShareFunc void gdImagePaletteCopy (gdImagePtr dst, gdImagePtr src);
BGD_DECLARE(void) gdImageGif (gdImagePtr im, FILE * out);
epicsShareFunc void gdImagePng (gdImagePtr im, FILE * out);
...
epicsShareFunc void gdImageGd (gdImagePtr im, FILE * out);
